...
On the other hand, the blockchain also needs to degrade gracefully under suboptimal network conditions. Magnus uses Simplex Consensus, which provides fast, sub-second finality in normal conditions while maintaining graceful degradation under adverse networks.
