...
# Simple MIP20 token creation, minting, and transfer example
...
echo "Creating and testing MIP20 token..."
...
cast rpc magnus_fundAddress $SENDER_ADDR
sleep 2
