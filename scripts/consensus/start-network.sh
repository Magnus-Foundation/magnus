...
DOCKER_IMAGE="magnus:latest"
NETWORK_NAME="magnus"

echo "=== Starting Magnus Network ==="
...
start_validator() {
  ...
  local config_file="$2"
  local container_name="magnus-validator-$validator_id"
...
echo "Validators:"
echo "  magnus-validator-0: http://localhost:8545"
echo "  magnus-validator-1: http://localhost:8546"
echo "  magnus-validator-2: http://localhost:8547"
echo "  magnus-validator-3: http://localhost:8548"
echo ""
