...
ansible-playbook --vault-password-file ./vault.key \
    --extra-vars "{\"tempo_bench_download_url\": \"https://api.github.com/repos/Magnus-Foundation/magnus/actions/artifacts/$MAGNUS_BENCH_DOWNLOAD_ID/zip\", \"tempo_bench_node_sha\": \"$MAGNUS_BENCH_NODE_SHA\", \"tempo_bench_build_profile\": \"$MAGNUS_BENCH_BUILD_PROFILE\", \"tempo_bench_target_urls\": [\"http://lento-node-1-1:8545\"], \"tempo_bench_benchmark_mode\": \"$MAGNUS_BENCH_BENCHMARK_MODE\"}" \
