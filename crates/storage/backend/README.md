...
Concrete storage backend for Magnus QMDB.

This crate implements the `QmdbGettable` and `QmdbBatchable` traits from [`magnus-qmdb`](../qmdb)
...
use magnus_backend::{CommonwareBackend, QmdbBackendConfig};
