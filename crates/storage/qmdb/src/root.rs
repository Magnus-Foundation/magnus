...
const MAGNUS_ROOT_NAMESPACE: &[u8] = b"_MAGNUS_QMDB_ROOT";
...
impl StateRoot {
    ...
    pub fn compute(accounts_root: B256, storage_root: B256, code_root: B256) -> B256 {
        let mut buf = Vec::with_capacity(MAGNUS_ROOT_NAMESPACE.len() + 96);
        buf.extend_from_slice(MAGNUS_ROOT_NAMESPACE);
