//! Integration tests for magnus-marshal initializers.
//!
...
use magnus_marshal::{ActorInitializer, ArchiveInitializer, BroadcastInitializer, PeerInitializer};
...
/// Sets up a validator using the magnus-marshal initializers.
