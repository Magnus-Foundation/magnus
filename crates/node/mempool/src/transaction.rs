...
use magnus_precompile_registry::nonce::NonceManager;
...
impl MagnusPooledTransaction {
    ...
    ///
    /// Based on classifier v1: payment if tx.to has MIP20 reserved prefix.
    ...
    ///
    /// If the [`MagnusTxEnv`] was pre-computed via [`Self::prepare_tx_env`], the cached
...
pub enum MagnusPoolTransactionError {
    ...
    #[error(
        "Invalid fee token: {0}, please see https://docs.magnus.xyz/errors/tx/InvalidFeeToken for more"
    )]
    ...
    #[error(
        "Native transfers are not supported, if you were trying to transfer a stablecoin, please call MIP20::Transfer"
    )]
    NonZeroValue,
    ...
    #[error(
        "Insufficient liquidity for fee token: {0}, please see https://docs.magnus.xyz/protocol/fees for more"
    )]
...
mod tests {
    ...
    fn test_payment_classification_positive() {
        // Test that MIP20 address prefix is correctly classified as payment
    ...
    // ============================================
    // MagnusPoolTransactionError::is_bad_transaction tests
    // ============================================
    ...
    fn test_error_is_bad_transaction_false_cases() {
        ...
        let false_cases = [
            ...
            MagnusPoolTransactionError::InvalidFeeToken(Address::ZERO),
            MagnusPoolTransactionError::MissingFeeToken,
            ...
            MagnusPoolTransactionError::Keychain("test error"),
            MagnusPoolTransactionError::InsufficientLiquidity(Address::ZERO),
    ...
    fn test_error_is_bad_transaction_true_cases() {
        ...
        let true_cases = [
            MagnusPoolTransactionError::NonZeroValue,
    ...
    // ============================================
    // cost() always returns zero (Magnus-specific)
    // ============================================
