...
Production-ready transaction pool for magnus-node with validation, nonce ordering, and fee prioritization.
...
```rust,ignore
use magnus_txpool::{TransactionPool, PoolConfig, TransactionValidator};
