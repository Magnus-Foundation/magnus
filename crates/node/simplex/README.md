...
Commonware simplex consensus engine integration for Magnus.
...
which drives BLS12-381 threshold signature-based consensus in Magnus nodes.
...
```rust,ignore
use magnus_simplex::{DefaultEngine, DefaultConfig, DefaultPool};
