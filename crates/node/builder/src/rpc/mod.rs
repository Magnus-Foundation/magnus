...
use std::sync::Arc;
pub use magnus_provider::rpc::MagnusTransactionRequest;
use magnus_chainspec::MagnusChainSpec;
use magnus_evm::MagnusStateAccess;
use magnus_precompile_registry::{NONCE_PRECOMPILE_ADDRESS, nonce::NonceManager};
...
use magnus_provider::{MagnusNetwork, rpc::MagnusTransactionReceipt};
    ...
    fn convert_receipts(
        ...
        self.inner
            ...
            .map(|(inner, tx)| {
                ...
                // fee token transfer to MIPFeeManager.
