...
use magnus_vm::evm::MagnusContext;

pub use magnus_vm::{MagnusBlockEnv, MagnusHaltReason, MagnusStateAccess};
...
impl MagnusEvmConfig {
    ...
    pub fn new(chain_spec: Arc<MagnusChainSpec>, evm_factory: MagnusEvmFactory) -> Self {
    ...
    /// Create a new [`MagnusEvmConfig`] with the given chain spec and default EVM factory.
    pub fn new_with_default_factory(chain_spec: Arc<MagnusChainSpec>) -> Self {
        Self::new(chain_spec, MagnusEvmFactory::default())
    }
...
impl BlockExecutorFactory for MagnusEvmConfig {
    ...
    fn create_executor<'a, DB, I>(
        &'a self,
        evm: MagnusEvm<&'a mut State<DB>, I>,
        ctx: Self::ExecutionCtx<'a>,
    ) -> impl BlockExecutorFor<'a, Self, DB, I>
    where
        DB: Database + 'a,
        I: Inspector<MagnusContext<&'a mut State<DB>>> + 'a,
    {
...
mod tests {
    ...
    fn test_evm_config_can_query_magnus_hardforks() {
        let evm_config = MagnusEvmConfig::new_with_default_factory(test_chainspec());
