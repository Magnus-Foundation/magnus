...
pub(crate) const DEFAULT_DOWNLOAD_URL: &str = "https://snapshots.magnus.network/42431";

fn init_download_urls() {
    let download_defaults = DownloadDefaults {
        available_snapshots: vec![
            Cow::Borrowed("https://snapshots.magnus.network/42431 (moderato)"),
            Cow::Borrowed("https://snapshots.magnus.network/42429 (andantino)"),
        ],
