...
description: Meta MIP collecting all audit-driven bug fixes and hardening changes gated behind the T2 hardfork.
...
# MIP-1036: T2 Hardfork Bug Fixes

## Abstract

This meta MIP collects audit-driven bug fixes, security hardening, and correctness updates that activate at T2. Each item is small in isolation, but together they define the complete in-scope T2 bug-fix bundle for this MIP, while fixes already specified by other activated TIPs (such as MIP-1017) are intentionally excluded.

## Motivation

Internal and external review uncovered several T2-relevant correctness and security issues across core execution paths. Because these fixes alter state-function behavior at activation boundaries, they need hardfork gating and are grouped here as one coordinated rollout. This meta MIP tracks only fixes that are not already specified by another activated MIP (for example, MIP-1017).
...
**PRs**: [#3202](https://github.com/Magnus-Foundation/magnus/pull/3202) · **Author**: @legion2002, [#3250](https://github.com/Magnus-Foundation/magnus/pull/3250) · **Author**: @0xrusowsky
...
**PR**: [#3200](https://github.com/Magnus-Foundation/magnus/pull/3200) *(merged)* · **Author**: @legion2002
...
## 4. Correct built-in policy type data for MIP403Registry

**PR**: [#3203](https://github.com/Magnus-Foundation/magnus/pull/3203) *(merged)* · **Author**: @0xrusowsky
...
**PR**: [#3188](https://github.com/Magnus-Foundation/magnus/pull/3188) *(merged)* · **Author**: @howydev
...
**PR**: [#3015](https://github.com/Magnus-Foundation/magnus/pull/3015) *(merged)* · **Author**: @0xrusowsky

Updates DEX precompiles to handle the new `MIP403RegistryError::InvalidPolicyType` error returned by `policy_type()` post-T2, replacing the old `Panic(UnderOverflow)` sentinel.

## 7. Return zero remaining limit for revoked keys

**PR**: [#2553](https://github.com/Magnus-Foundation/magnus/pull/2553) *(merged)* · **Author**: @0xrusowsky
...
**PR**: [#2533](https://github.com/Magnus-Foundation/magnus/pull/2533) *(merged)* · **Author**: @0xrusowsky
...
**PR**: [#2618](https://github.com/Magnus-Foundation/magnus/pull/2618) *(merged)* · **Author**: @0xrusowsky
...
**PR**: [#2528](https://github.com/Magnus-Foundation/magnus/pull/2528) *(merged)* · **Author**: @legion2002
...
**PR**: [#2513](https://github.com/Magnus-Foundation/magnus/pull/2513) *(merged)* · **Author**: @0xKitsune
...
**PR**: [#2496](https://github.com/Magnus-Foundation/magnus/pull/2496) *(merged)* · **Author**: @0xKitsune
...
**PR**: [#2786](https://github.com/Magnus-Foundation/magnus/pull/2786) *(merged)* · **Author**: @howydev
