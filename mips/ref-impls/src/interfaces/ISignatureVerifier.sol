...
/// @notice Interface for the MIP-1020 Signature Verification Precompile
...
interface ISignatureVerifier {
    ...
    /// @notice Recovers the signer of a Magnus signature (secp256k1, P256, WebAuthn).
    /// @param hash The message hash that was signed
    /// @param signature The encoded signature (see Magnus Transaction spec for formats)
    ...
    /// @notice Verifies a signer against a Magnus signature (secp256k1, P256, WebAuthn).
