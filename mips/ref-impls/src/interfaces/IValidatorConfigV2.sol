...
interface IValidatorConfigV2 {
    ...
    ///      keccak256(abi.encodePacked("MAGNUS", "_VALIDATOR_CONFIG_V2_ADD_VALIDATOR", chainId, contractAddress, validatorAddress, ingress, egress))
    ...
    ///      keccak256(abi.encodePacked("MAGNUS", "_VALIDATOR_CONFIG_V2_ROTATE_VALIDATOR", chainId, contractAddress, validatorAddress, ingress, egress))
