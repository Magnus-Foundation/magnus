...
/// @title MIP-1022 virtual address registry interface
/// @notice Registers master addresses and resolves virtual MIP-20 recipients to their masters
interface IAddressRegistry {
    ...
    /// @notice Resolves `to` under MIP-1022 rules.
    ...
    /// @notice Returns `true` when `addr` matches the MIP-1022 virtual address layout.
