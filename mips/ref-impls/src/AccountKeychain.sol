...
///         scoped secondary keys with expiry timestamps and per-MIP20 token spending limits.
...
contract AccountKeychain is IAccountKeychain {
    ...
    /// @dev This would be called by the protocol during MIP20 transfers to enforce spending limits
