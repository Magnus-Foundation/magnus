...
/// @title MIP-1010 Block Gas Limits Invariant Tests
/// @notice Fuzz-based invariant tests for Magnus's block gas parameters
...
contract BlockGasLimitsInvariantTest is InvariantBase {
    ...
    function handler_txGasCapEnforcement(uint256 actorSeed, uint256 gasMultiplier) external {
        ...
        bytes memory callData = abi.encodeCall(IMIP20.transfer, (actors[0], 1e6));
