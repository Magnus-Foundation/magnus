...
/// @notice Fuzz-based invariant tests for the MIP-1020 Signature Verification Precompile
/// @dev Tests invariants SV1-SV4, SV6, SV7 from the MIP-1020 spec. The precompile is
...
/// forge-config: magnus_ci.invariant.depth = 300
