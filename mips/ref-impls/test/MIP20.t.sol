...
contract MIP20Test is BaseTest {
    ...
    event NextQuoteTokenSet(address indexed updater, MIP20 indexed nextQuoteToken);
    event QuoteTokenUpdate(address indexed updater, MIP20 indexed newQuoteToken);
    ...
    function testTransferFromWithMemoInsufficientAllowance() public {
        ...
        try token.transferFromWithMemo(alice, charlie, amount, TEST_MEMO) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.InsufficientAllowance.selector));
        }
        vm.stopPrank();
    ...
    function testTransferWithMemoWhenPaused() public {
        ...
        try token.transferWithMemo(bob, 100e18, TEST_MEMO) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.ContractPaused.selector));
        }
        vm.stopPrank();
    }
    ...
    function testTransferToInvalidRecipient() public {
        ...
        try token.transfer(address(0), 100e18) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.InvalidRecipient.selector));
        }
    ...
    function testMintWithMemoSupplyCapExceeded() public {
        ...
        try token.mintWithMemo(charlie, 200e18, TEST_MEMO) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.SupplyCapExceeded.selector));
        }
        ...
        try token.burnWithMemo(100e18, TEST_MEMO) {
            ...
            assertEq(
                ...
                abi.encodeWithSelector(
                    IMIP20.InsufficientBalance.selector,
    ...
    function testMintWithMemoRequiresIssuerRole() public {
        ...
        try token.mintWithMemo(charlie, 100e18, TEST_MEMO) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20RolesAuth.Unauthorized.selector));
        }
        vm.stopPrank();
    }
    ...
    function testPolicyForbidsAllCases() public {
        ...
        uint64 blockingPolicy = registry.createPolicyWithAccounts(
            admin, IMIP403Registry.PolicyType.BLACKLIST, accounts
        );
    ...
    function testFuzz_ChangeTransferPolicyId_RevertsIf_PolicyNotFound(uint64 policyId) public {
        ...
        try token.changeTransferPolicyId(policyId) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.InvalidTransferPolicyId.selector));
        }
    }
    ...
    function testSetNextQuoteTokenToInvalidAddress() public {
        ...
        try token.setNextQuoteToken(MIP20(address(0))) {
            revert CallShouldHaveReverted();
        } catch (bytes memory err) {
            assertEq(err, abi.encodeWithSelector(IMIP20.InvalidQuoteToken.selector));
        }
    ...
    function testSetSupplyCapBelowTotalSupply() public {
        ...
        try token.setSupplyCap(1000e18) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.InvalidSupplyCap.selector));
        }
    }
    ...
    function testBurnInsufficientBalance() public {
        ...
        try token.burn(100e18) {
            ...
            assertEq(
                err,
                abi.encodeWithSelector(
                    IMIP20.InsufficientBalance.selector, 0, 100e18, address(token)
                )
            );
        }
    }
    ...
    function testTransferInsufficientBalance() public {
        ...
        try token.transfer(bob, 2000e18) {
            ...
            assertEq(
                err,
                abi.encodeWithSelector(
                    IMIP20.InsufficientBalance.selector, 1000e18, 2000e18, address(token)
                )
            );
        }
    }
    ...
    function testRewardInjectionWithNoOptedIn() public {
        ...
        try token.distributeReward(100e18) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.NoOptedInSupply.selector));
        }
    }
    ...
    function test_Reward_RevertsWithZeroAmount() public {
        ...
        try token.distributeReward(0) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.InvalidAmount.selector));
        }
    ...
    function testBurnBlocked_RevertsIf_ProtectedAddress() public {
        ...
        try token.burnBlocked(0xfeEC000000000000000000000000000000000000, 100e18) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.ProtectedAddress.selector));
        }
    ...
    function test_Mint_Succeeds_AuthorizedMintRecipient_CompoundPolicy() public {
        ...
        uint64 senderWhitelist = registry.createPolicy(admin, IMIP403Registry.PolicyType.WHITELIST);
        uint64 recipientWhitelist =
            registry.createPolicy(admin, IMIP403Registry.PolicyType.WHITELIST);
        uint64 mintWhitelist = registry.createPolicy(admin, IMIP403Registry.PolicyType.WHITELIST);
    ...
    function test_Mint_Fails_UnauthorizedMintRecipient_CompoundPolicy() public {
        ...
        try compoundToken.mint(charlie, 1000) {
            ...
            assertEq(bytes4(err), IMIP20.PolicyForbids.selector);
        }
    ...
    function test_Permit_Replay() public {
        ...
        try token.permit(signer, bob, value, deadline, v, r, s) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP20.InvalidSignature.selector));
        }
    ...
    function test_Permit_Fail() public {
        ...
        // 1. Expired deadline
        {
            ...
            try token.permit(signer, bob, value, expiredDeadline, v, r, s) {
                ...
                assertEq(err, abi.encodeWithSelector(IMIP20.PermitExpired.selector));
            }
            assertEq(token.nonces(signer), 0);
        }
