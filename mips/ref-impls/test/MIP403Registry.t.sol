...
contract MIP403RegistryTest is BaseTest {
    ...
    function test_CreatePolicy_Basic() public {
        address admin = alice;
        MIP403Registry.PolicyType policyType = IMIP403Registry.PolicyType.WHITELIST;
        ...
        (MIP403Registry.PolicyType storedType, address storedAdmin) =
    ...
    function test_CreatePolicy_WithInitialAccounts_Blacklist() public {
        address admin = alice;
        MIP403Registry.PolicyType policyType = IMIP403Registry.PolicyType.BLACKLIST;
        address[] memory accounts = new address[](2);
        accounts[0] = alice;
        accounts[1] = bob;
    ...
    function test_SetPolicyAdmin_Success() public {
        ...
        uint64 policyId = registry.createPolicy(alice, IMIP403Registry.PolicyType.WHITELIST);
    ...
    function test_SetPolicyAdmin_Unauthorized() public {
        ...
        try registry.setPolicyAdmin(policyId, charlie) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP403Registry.Unauthorized.selector));
        }
    }
    ...
    function test_SetPolicyAdmin_OnlyAdminCanChange() public {
        ...
        uint64 policyId = registry.createPolicyWithAccounts(
            charlie, IMIP403Registry.PolicyType.WHITELIST, accounts
        );
        ...
        public
    {
        ...
        uint64 policyId = registry.createPolicy(address(0), IMIP403Registry.PolicyType.WHITELIST);
    ...
    function test_ModifyPolicyWhitelist_AddToWhitelist() public {
        uint64 policyId = registry.createPolicy(bob, IMIP403Registry.PolicyType.WHITELIST);
    ...
    function test_ModifyPolicyWhitelist_RemoveFromWhitelist() public {
        ...
        accounts[0] = alice;
        uint64 policyId =
            registry.createPolicyWithAccounts(bob, IMIP403Registry.PolicyType.WHITELIST, accounts);
    ...
    function test_ModifyPolicyWhitelist_IncompatiblePolicyType() public {
        uint64 policyId = registry.createPolicy(alice, IMIP403Registry.PolicyType.BLACKLIST);

        vm.prank(alice);
        try registry.modifyPolicyWhitelist(policyId, bob, true) {
            revert CallShouldHaveReverted();
        } catch (bytes memory err) {
            assertEq(err, abi.encodeWithSelector(IMIP403Registry.IncompatiblePolicyType.selector));
        }
    }
    ...
    function test_ModifyPolicyWhitelist_PolicyNotFound() public {
        try registry.modifyPolicyWhitelist(999, alice, true) {
            ...
            assertEq(err, abi.encodeWithSelector(IMIP403Registry.PolicyNotFound.selector));
        }
    }
    ...
    function test_ModifyPolicyBlacklist_AddToBlacklist() public {
        uint64 policyId = registry.createPolicy(bob, IMIP403Registry.PolicyType.BLACKLIST);
    ...
    function test_ModifyPolicyBlacklist_RemoveFromBlacklist() public {
        ...
        accounts[0] = alice;
        uint64 policyId =
            registry.createPolicyWithAccounts(bob, IMIP403Registry.PolicyType.BLACKLIST, accounts);
    ...
    function test_IsAuthorized_WhitelistPolicy() public {
        uint64 policyId = registry.createPolicy(david, IMIP403Registry.PolicyType.WHITELIST);
    ...
    function test_IsAuthorized_BlacklistPolicy() public {
        uint64 policyId = registry.createPolicy(david, IMIP403Registry.PolicyType.BLACKLIST);
    ...
    function test_IsAuthorized_ComplexWhitelistScenario() public {
        ...
        uint64 policyId = registry.createPolicyWithAccounts(
            david, IMIP403Registry.PolicyType.WHITELIST, initialAccounts
        );
    ...
    function test_IsAuthorized_ComplexBlacklistScenario() public {
        ...
        uint64 policyId = registry.createPolicyWithAccounts(
            david, IMIP403Registry.PolicyType.BLACKLIST, initialAccounts
        );
    ...
    function test_GetPolicyIdCounter() public {
        ...
        // Create a policy
        registry.createPolicy(alice, IMIP403Registry.PolicyType.WHITELIST);

        uint64 newCount = registry.policyIdCounter();
        assertEq(newCount, 3);

        // Create another policy
        registry.createPolicy(bob, IMIP403Registry.PolicyType.BLACKLIST);
    ...
    function test_Events_PolicyCreation_Basic() public {
        ...
        emit IMIP403Registry.PolicyCreated(
            FIRST_USER_POLICY, address(this), IMIP403Registry.PolicyType.WHITELIST
        );

        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.PolicyAdminUpdated(FIRST_USER_POLICY, address(this), alice);
    ...
    function test_Events_PolicyCreation_WithAccounts() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(FIRST_USER_POLICY, address(this), alice, true);

        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(FIRST_USER_POLICY, address(this), bob, true);
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.PolicyAdminUpdated(FIRST_USER_POLICY, address(this), charlie);

        registry.createPolicyWithAccounts(charlie, IMIP403Registry.PolicyType.WHITELIST, accounts);
    }
    ...
    function test_Events_PolicyCreation_BlacklistWithAccounts() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.BlacklistUpdated(FIRST_USER_POLICY, address(this), alice, true);

        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.BlacklistUpdated(FIRST_USER_POLICY, address(this), bob, true);

        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.PolicyCreated(
            FIRST_USER_POLICY, address(this), IMIP403Registry.PolicyType.BLACKLIST
        );

        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.PolicyAdminUpdated(FIRST_USER_POLICY, address(this), charlie);

        registry.createPolicyWithAccounts(charlie, IMIP403Registry.PolicyType.BLACKLIST, accounts);
    }
    ...
    function test_Events_PolicyCreation_WithAdmin() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.PolicyAdminUpdated(FIRST_USER_POLICY, address(this), bob);
    ...
    function test_Events_WhitelistUpdate_Add() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(policyId, bob, alice, true);
    ...
    function test_Events_WhitelistUpdate_Remove() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(policyId, bob, alice, false);
    ...
    function test_Events_BlacklistUpdate_Add() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.BlacklistUpdated(policyId, bob, alice, true);
    ...
    function test_Events_BlacklistUpdate_Remove() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.BlacklistUpdated(policyId, bob, alice, false);
    ...
    function test_Events_PolicyAdminUpdate() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.PolicyAdminUpdated(policyId, alice, bob);
    ...
    function test_Events_PolicyAdminUpdate_Complex() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.PolicyAdminUpdated(policyId, bob, charlie);
    ...
    function test_Events_MultipleUpdates() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(policyId, david, alice, true);

        vm.prank(david);
        registry.modifyPolicyWhitelist(policyId, alice, true);

        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(policyId, david, bob, true);

        vm.prank(david);
        registry.modifyPolicyWhitelist(policyId, bob, true);

        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(policyId, david, charlie, true);
        ...
        // Remove one account
        vm.expectEmit(true, true, true, true);
        emit IMIP403Registry.WhitelistUpdated(policyId, david, alice, false);
    ...
    function test_AdminPolicy_Authorization_Whitelist() public {
        ...
        uint64 policyId = registry.createPolicyWithAccounts(
            alice, IMIP403Registry.PolicyType.WHITELIST, accounts
        );
    ...
    function test_Authorization_OnlyAdminCanUpdate() public {
        ...
        accounts[0] = bob;
        uint64 policyId = registry.createPolicyWithAccounts(
            alice, IMIP403Registry.PolicyType.BLACKLIST, accounts
        );
    ...
    function test_ComplexAdminChain() public {
        ...
        uint64 policy1 = registry.createPolicy(alice, IMIP403Registry.PolicyType.WHITELIST);
        uint64 policy2 = registry.createPolicy(bob, IMIP403Registry.PolicyType.WHITELIST);
        uint64 policy3 = registry.createPolicy(charlie, IMIP403Registry.PolicyType.WHITELIST);
    ...
    function test_CreateCompoundPolicy_Basic() public {
        uint64 whitelist = registry.createPolicy(alice, IMIP403Registry.PolicyType.WHITELIST);
        uint64 blacklist = registry.createPolicy(alice, IMIP403Registry.PolicyType.BLACKLIST);
    ...
    function test_CreateCompoundPolicy_HasNoAdmin() public {
        ...
        (IMIP403Registry.PolicyType policyType, address policyAdmin) = registry.policyData(compound);
        assertEq(uint8(policyType), uint8(IMIP403Registry.PolicyType.COMPOUND));
    ...
    function test_CreateCompoundPolicy_CannotReferenceCompound() public {
        ...
        vm.expectRevert(IMIP403Registry.PolicyNotSimple.selector);
    ...
    function test_CreateCompoundPolicy_RevertsOnNonExistentPolicy() public {
        ...
        try registry.createCompoundPolicy(nonExistent, whitelist, whitelist) returns (uint64) {
            ...
            assertEq(bytes4(err), IMIP403Registry.PolicyNotFound.selector);
        }
    ...
    function test_CompoundPolicyData_RevertsForNonCompound() public {
        ...
        try registry.compoundPolicyData(whitelist) returns (uint64, uint64, uint64) {
            ...
            assertEq(bytes4(err), IMIP403Registry.IncompatiblePolicyType.selector);
        }
    }
    ...
    function test_CompoundPolicy_DirectionalAuthorization() public {
        uint64 senderWhitelist = registry.createPolicy(alice, IMIP403Registry.PolicyType.WHITELIST);
    ...
    function testFuzz_SimplePolicyEquivalence(uint256 policySeed, address user) public {
        ...
        IMIP403Registry.PolicyType policyType = policySeed % 2 == 0
        ...
        if (policySeed % 3 == 0) {
            vm.prank(alice);
            if (policyType == IMIP403Registry.PolicyType.WHITELIST) {
