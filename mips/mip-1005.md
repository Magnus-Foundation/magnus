...
# MIP-1005: Fix ask swap rounding loss

## Abstract

This MIP fixes a rounding bug in the `swapExactAmountIn` function when filling ask orders. Due to double-rounding, the maker can receive slightly less quote tokens than the taker paid, causing tokens to be lost.
...
The fix requires changes to two functions in [`docs/specs/src/StablecoinDEX.sol`](https://github.com/Magnus-Foundation/magnus/blob/main/docs/specs/src/StablecoinDEX.sol):

### 1. `_fillOrder` ([line 551-556](https://github.com/Magnus-Foundation/magnus/blob/main/docs/specs/src/StablecoinDEX.sol#L551-L556))
...
### 2. `_fillOrdersExactIn` ([line 923-926](https://github.com/Magnus-Foundation/magnus/blob/main/docs/specs/src/StablecoinDEX.sol#L923-L926))
