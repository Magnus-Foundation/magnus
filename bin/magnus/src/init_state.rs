...
//!
//! This command loads MIP20 storage slots from a binary file and applies them
//! to the genesis state. The binary format is produced by `magnus-xtask generate-state-bloat`.
...
pub(crate) struct InitFromBinaryDump<C: reth_cli::chainspec::ChainSpecParser = MagnusChainSpecParser>
{
    ...
    ///
    /// The file should be generated by `magnus-xtask generate-state-bloat`.
    ...
    InitFromBinaryDump<C>
{
    ...
    {
        info!(target: "magnus::cli", "Magnus init-from-binary-dump starting");
        ...
        info!(target: "magnus::cli", path = %self.state.display(), "Loading binary state dump");
        ...
        loop {
            ...
            // Preserving the genesis account is critical: MIP20 tokens have bytecode (0xEF)
        ...
        // This preserves bytecode_hash for genesis accounts (e.g. MIP20 tokens with 0xEF code).
